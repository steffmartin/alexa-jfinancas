...
SELECT VENCIMENTO, CAST(SUM(VALOR) AS NUMERIC(18,2)) FROM (
...
SELECT PCPAI.NOME, PC.NOME, CR.HISTORICO, CR.VENCIMENTO ,C.NOME, CLI.NOMEFANTASIA, CAST(CR.VALOR AS NUMERIC(18,2))
FROM CRECEBER cr
...
SELECT PCPAI.NOME, PC.NOME, Cp.HISTORICO, Cp.VENCIMENTO , C.NOME, CLI.NOMEFANTASIA,  CAST(Cp.VALOR  AS NUMERIC(18,2))
FROM CPAGAR cp
...
SELECT tc.DESCRICAO, c.NOME, tp.VENCIMENTO, tp.HISTORICO, CAST(tp.VALOR  AS NUMERIC(18,2))
FROM TRANSF_PROG tp
